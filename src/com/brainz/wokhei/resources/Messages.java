...
public enum Messages {
	...
	LOGO_NAME_HELP_MESSAGE("This is the name of the company, product, service, website, association, etc. that your logo is for. This name will appear in the logo unless you specify the #notext tag, in that case the logo will only be a symbolic representation."),
	...
	LOGO_COLOUR_HELP_MESSAGE("This will be your logo primary colour. Note that the logo will have different shades of the main coulour you pick."),
	LOGO_TAGS_TXTBOX("use the tags to describe what the logo is for."),
	...
	ACCEPTED_TEXT("You request has been accepted by our chef Tony - in 24hrs you will receive the logo you requested. We are tasking one of our help-chefs with the job!"),
	REJECTED_TITLE("Request rejected"),
	REJECTED_TEXT("Our chef Tony rejected this order. This can happen if the request violated some copyright, looked like a joke or ... Tony just didn't like it. Go ahead - give it another shot!"),
	...
	QUALITY_GATE_TITLE("Screening quality..."),
	...
	FIRST_STEP("Insert your product/company/service name, up to 5 tags to describe your logo and pick your preference for the main colour: as easy as that!"),
	SECOND_STEP("Once your request is accepted it will be assigned to one of the graphic designers in the Wokhei network with expertise in your product area. He will prepare your logo in 24hrs!"),
	THIRD_STEP("You can buy the logo within 24hrs from the first time you view it for only 49.90 Euros to use it under the Wokhei Commercial Licence. Or ... you can use it for free under the Wokhei Limited Licence!"), 
	...
	ABOUT_MENU_RESTAURANT_TEXT("Because Wokhei is your favourite place when you're hungry for stir fried logos!\n\nThe concept behind Wokhei is driven by the metaphor of culinary deli as artistic expression.\nCustomers in need of a tasty logo for their company or product reach out to Wokhei to get a mouthful of stir fried goodness in a reasonable time for a reasonable price, and Wokhei always responds with tasteful bites!"),
	ABOUT_MENU_GRAPHICSNETWORK_TEXT("Wokhei is a dynamic and increasingly growing network of professional designers evenly distributed throughout the 4 continents.\n\nSee the careers section if you wish to gather more information about the unique opportunity of joining the Wokhei network."),
	...
	FAQ_1_ANSWER("No!\n\nAt the moment having a Google account is the only way to access Wokhei services.\n\nWhy? Because virtually everyone has a Google account and this way you don't have to remember yet another password. Ok, also because we are huge Google fans."),
	...
	FAQ_3_ANSWER("The tags you have to pick when ordering your logo are descriptive labels to help designers understand what you need the logo for and how you would like your logo to look like.\n\nBe sure to pick your tags carefully!"),
	...
	FAQ_6_ANSWER("Fair enough question!\n\nThe fair enough answer is that if you don't buy your logo someone else can pick it up from the gallery (coming soon) and use it for their own non-commercial purposes for free ... "),
	FAQ_7("How do I pay for my logo?"),
	FAQ_7_ANSWER("You can easily pay through Paypal using your Paypal account or directly via credit card."),
	FAQ_8("Question 8?"),
