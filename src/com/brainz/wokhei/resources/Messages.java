...
public enum Messages {
	...
	FAQ_6_ANSWER("Fair enough question!<br>Here's the answer: If you don't buy the logo you will be able to use it only under the Wokhei Limited License, which excludes any commercial use. Also, if you don't buy your logo someone else can pick it up from the gallery (coming soon) and use it!"),
