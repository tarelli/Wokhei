...
public enum Messages {
	...
	REVIEWED_WAITMSG(
	"Thanks to your suggestions the logo is now ready to become yours!"),
	...
	ACCEPTED_TEXT(
	"You request has been accepted - in 24hrs your logo will be ready. Your logo is being assigned to one of the designers in the Wokhei network with expertise in your area."),
	...
	QUALITY_GATE_TEXT(
	"We take very seriously the quality of your logo. We are now reviewing your logo and making sure it is as good as you deserve!"),
	...
	VIEWED_TEXT(
	"Your logo is ready! You can buy it now for 98 EUR (VAT Included) or if you wish to request some further changes please claim your FREE revision!"),

	REVIEWING_TITLE("Taking onboard your changes!"),

	REVIEWING_TEXT(
	"Thanks for your suggestions, we are now working on the changes you requested for your logo. It will be ready in 24hrs!"),
	...
	BOUGHT_TEXT(
	"You are a proud owner of a stir fried logo! Now it's your turn to make money!"),
