...
public class OrderUtils {
	...
	public static OrderDTO getOrderDTO(Order order) 
	{
		...
		return new OrderDTO(order.getId(),order.getText(),strArr,order.getDate(),order.getAcceptedDate(),order.getViewedDate(),order.getStatus(),order.getColour(), order.getCustomer().getEmail(),order.getProgressive(),order.getRevisionCounter());
	}
